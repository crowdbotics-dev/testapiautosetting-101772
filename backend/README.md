...
## Project Structure
    ...
    ├── testapiautosetting_101772  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_101772`
...
2. Clone this repo and `cd testapiautosetting_101772`
